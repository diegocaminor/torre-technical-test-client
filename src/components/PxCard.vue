        ...
        <div class="torre-card__unit-stats torre-card__unit-stats--company clearfix">
          <div v-if="compensation" class="one-third">
            <div v-if="compensation.data">
              <div v-if="compensation.data.maxAmount" class="stat large-text">{{ compensation.data.periodicity }} <small>{{ compensation.data.currency }}</small> {{ compensation.data.maxAmount }} <span>💰</span></div>
